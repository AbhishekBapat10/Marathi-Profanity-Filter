...
# Load the dataset
data_path = r"C:\Users\Abhis\Desktop\Marathi Profanity Filter\Marathi Profanity.xlsx"  # Change this to the path of your Excel file
df = pd.read_excel(data_path)
...
# Streamlit app
st.title("Marathi Profanity Filter")
